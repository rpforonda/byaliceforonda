...
<section class="mx-auto max-w-3xl px-6 py-8 sm:py-12 md:py-16 text-center min-h-[calc(100vh-400px)] bg-[#FDF8E2]">
  <div class="relative mx-auto max-w-[280px] sm:max-w-sm shadow-xl mb-6 sm:mb-8">
    <img
  ...
  <div class="mt-3 sm:mt-4 mx-auto max-w-2xl px-4 text-left">
